...
REDPANDA_TOPIC = "cisaf.facilities"
BRONZE_PATH = "/home/vaishu19/energy-compliance-platform/datalake/bronze/facilities"
CHECKPOINT_PATH = "/home/vaishu19/energy-compliance-platform/spark/checkpoints/bronze_facilities"
SASL_CONFIG = (
...
print("Bronze facilities ingestion complete.")
from delta.tables import DeltaTable
dt = DeltaTable.forPath(spark, BRONZE_PATH)
print(f"Bronze facilities row count: {dt.toDF().count()}")
spark.stop()
